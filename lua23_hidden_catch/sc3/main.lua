...
function Lua_Init()
	...
	Lfont.Setup(g_fntScore, "점수: 0", 20, 400, "0xFFcc3300")
	...
	Lfont.Setup(g_fntMsg, "Game Over", 100, 230, "0xFF03300")
	...
	if KEY_DOWN == g_mouse.e then
		...
		if 0 < idx then
			...
			if 10 == #g_check then
				...
				g_score = g_score + g_timeR * 3000
				Lfont.String(g_fntScore, "점수: " .. g_score)

				Lfont.String(g_fntMsg, "성공")
				Lfont.Color(g_fntMsg, "0xFF0000FF")
				return 0
			end
		end
	end
